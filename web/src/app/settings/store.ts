...
type SettingsStore = {
  ...
  setRegisterFlaresolverr: (value: string) => void;
...
export const useSettingsStore = create<SettingsStore>((set, get) => ({
  ...
  setRegisterFlaresolverr: (value) => {
    set((state) => state.registerConfig ? { registerConfig: { ...state.registerConfig, flaresolverr: value } } : {});
  },
  ...
  saveRegister: async () => {
    ...
    try {
      ...
      const data = await updateRegisterConfig({
        ...
        flaresolverr: registerConfig.flaresolverr.trim(),
